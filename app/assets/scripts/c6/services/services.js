...
.service('C6PostMessageService', ['$window', '$rootScope', '$q', 'c6EventEmitter', '$timeout', function($window, $rootScope, $q, c6EventEmitter, $timeout) {
    var _private = {
...
.service('C6SiteService', ['$window', '$q', 'c6EventEmitter', 'C6PostMessageService', '$http', '$compile', '$timeout', '$injector',
         function($window, $q, c6EventEmitter, C6PostMessageService, $http, $compile, $timeout, $injector) {
    var self = this,
        $rootScope,
        $location,
        _private = {
    ...
    this.init = function(config) {
        var session = C6PostMessageService.createSession($window.parent);
