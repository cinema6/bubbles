            ...
            return {
                ...
                'annotations' : {
                    'options' : {
                     ...
                     'notes'  : [
                        { 'ts': 7.25,'template':'${1}', 'duration':1.25, tail: {type:'speech', pos: 'bottomLeft'} },
                        { 'ts': 16,'template':'My dramatic entrance', tail: {type:'thought', pos: 'bottomLeft'} },
                        { 'ts': 18,'template':'Must look tough', tail: {type:'thought', pos: 'bottomLeft'} },
                        { 'ts': 20,'template':'Crazy ${2} stare', 'duration': 2, tail: {type:'thought', pos: 'topLeft'} },
                        { 'ts': 22,'template':'${2} ${3}', tail: {type:'thought', pos: 'topLeft'}},
                        { 'ts': 39,'template':'Get Out', tail: {type:'thought', pos: 'bottomRight'} },
                        { 'ts': 41,'template':'Or I will crush your ${4} into ${5}', 'duration':2, tail: {type:'thought', pos: 'topLeft'} },
                        { 'ts': 50,'template':'What can I say to make them leave?', 'duration':2.5, tail: {type:'thought', pos: 'bottomLeft'} },
                        { 'ts': 60,'template':'${5}!!!', 'duration':2, tail: {type:'thought', pos: 'bottomLeft'} },
                        { 'ts': 86,'template':'Did I leave the ${6} on???', 'duration':2, tail: {type:'thought', pos: 'bottomRight'} },
                        { 'ts': 95,'template':'Handcuffs of Drunken ${7}!!', tail: {type:'speech', pos: 'topRight'} },
                        { 'ts':100,'template':'Bruce Lee > ${7}!', 'duration':2, tail: {type:'speech', pos: 'topLeft'} },
                        { 'ts':116, 'template':'I\'m ${8}!', 'duration': 2, tail: {type:'speech', pos: 'bottomLeft'} },
                        { 'ts':118,'template':'No, you\'re a dumb Ewok', 'duration': 2, tail: {type:'speech', pos: 'bottomRight'} },
                        { 'ts':120,'template':'Shut up stupid!', 'duration':2, tail: {type:'speech', pos: 'bottomLeft'} },
                        { 'ts':123,'template':'Good comeback ${9}', 'duration':2, tail: {type:'speech', pos: 'bottomRight'} },
                        { 'ts':125,'template':'${10}', 'duration':2, tail: {type:'speech', pos: 'bottomLeft'} },
                        { 'ts':127.5,'template':'That made no sense', 'duration':1.5, tail: {type:'speech', pos: 'bottomRight'} },
                        { 'ts':129.5,'template':'${6}?', 'duration':1.5, tail: {type:'speech', pos: 'bottomLeft'} },
                        { 'ts':131.5,'template':'${2} ${3}!', 'duration':1.5, tail: {type:'thought', pos: 'bottomRight'} }
                    ]
                }
            };
        } else
